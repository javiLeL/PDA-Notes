...
public class SQLite extends SQLiteOpenHelper {
    ...
    final String TABLA_EVETOS = "CREATE TABLE eventos(id INTEGER PRIMARY KEY AUTOINCREMENT, titulo TEXT, tipo TEXT, fecha DATE, hora TIME, correo TEXT, FOREIGN KEY (correo) REFERENCES usuarios(correo) ON DELETE CASCADE)";
